...
DBCC CHECKIDENT (LOAILOP, RESEED,-1)
...
DBCC CHECKIDENT (CAPLOP, RESEED,-1)
...
DELETE FROM dbo.LOP
DBCC CHECKIDENT (LOP, RESEED,-1)
SELECT* FROM dbo.LOP

INSERT INTO dbo.LOP(TENLOP,SISO,CAHOC,HOCPHI,NGAYNHAPHOC,NGAYKETTHUC,MACAPLOP,MALOAILOP,MANHANVIEN)
VALUES(null,0,null,0,null,null,0,0,14),
	  (N'Toeic cấp A',10,N'3',1000000.0,'2010/10/10','2011/01/10',1,1,2),
	  (N'Toeic cấp A',10,N'1',1000000.0,'2011/01/11','2011/04/11',1,1,3),
	  (N'Toeic cấp B',15,N'2',2500000.0,'2011/05/10','2011/09/10',2,1,4),
	  (N'Anh Văn Tổng Quát cấp A',10,N'6',1500000.0,'2011/05/10','2011/09/10',1,3,3),
	  (N'Anh Văn Tổng Quát cấp A',10,N'1',1500000.0,'2011/05/10','2011/09/10',1,3,2),
	  ...
	  (N'Anh văn giao tiếp cấp C',5,N'1',5500000.0,'2010/10/10','2011/01/10',3,3,4),
	  (N'Anh Văn giao tiếp cấp B',15,N'3',3200000.0,'2011/05/10','2011/09/10',2,2,5),
	  (N'Anh Văn giao tiếp cấp A',10,N'1',1700000.0,'2011/05/10','2011/09/10',1,2,6)
...
VALUES
(N'Nguyễn Văn A','1999/01/01',1,'0324553946','A@gmail.com',N'Đạo Lý- Lý Nhân-Hà Nam','A','Toeic',1000000,0,'3','2010/10/10','2010/09/27',1),
(N'Nguyễn Văn B','1998/01/01',1,'0324553922','B@gmail.com',N'Đạo Lý- Lý Nhân-Hà Nam','A','Toeic',1000000,0,'3','2010/10/10','2010/09/27',2),
(N'Nguyễn Văn C','1997/01/21',1,'0324553921','C@gmail.com',N'Đạo Lý- Lý Nhân-Hà Nam','A','Toeic',1000000,0,'3','2010/10/10','2010/09/27',3),
(N'Nguyễn Văn D','1999/02/01',1,'0324555922','D@gmail.com',N'Đạo Lý- Lý Nhân-Hà Nam','A','Toeic',1000000,0,'3','2010/10/10','2010/09/27',4),
(N'Nguyễn Thị A','1999/01/01',0,'0324513946',N'A1@gmail.com',N'Đạo Lý- Lý NhâN-Hà Nam',N'A',N'Toeic',1000000.0,0,N'Ca 3','2012/03/10','2012/02/28',NULL),
(N'Nguyễn Thị B','1998/01/10',0,'0324213926',N'B1@gmail.com',N'Đạo Lý- Lý NhâN-Hà Nam',N'A',N'Toeic',1000000.0,0,N'Ca 2','2012/03/10','2012/02/28',NULL),
(N'Nguyễn Thị C','1997/01/01',1,'0324321126',N'C1@gmail.com',N'Đạo Lý- Lý NhâN-Hà Nam',N'A',N'Toeic',1000000.0,0,N'Ca 2','2012/03/10','2012/02/28',NULL),
(N'Nguyễn Văn A','1999/01/01',1,'0324553646',N'A@gmail.com',N'Đạo Lý- Lý Nhân-Hà Nam',N'B',N'Toeic',2000000.0,500000,N'Ca 3','2010/10/10','2010/09/30',1),
...
INSERT INTO dbo.DANGKI(TENHOCVIEN,NGAYSINH,GIOITINH,SDT,EMAIL,DIACHI,TENCAPLOP,TENLOAILOP,HOCPHI,HOCPHINO,CAHOC,NGAYNHAPHOC,NGAYDANGKI,MAHOCVIEN)
VALUES(N'Nguyễn Văn Công','1998/02/01',1,'0841632243','congcc@gmail.com',N'Hà Tây','B','Anh văn giao tiếp',2000000,500000,'3','2012/01/10','2012/01/01',NULL)
INSERT INTO dbo.DANGKI(TENHOCVIEN,NGAYSINH,GIOITINH,SDT,EMAIL,DIACHI,TENCAPLOP,TENLOAILOP,HOCPHI,HOCPHINO,CAHOC,NGAYNHAPHOC,NGAYDANGKI,MAHOCVIEN)
VALUES(N'Nguyễn Văn Chiến','1997/11/01',1,'0841632343','chiencc@gmail.com',N'Hà Tây','B','Anh văn giao tiếp',2000000,500000,'3','2012/01/10','2012/01/01',NULL)
...
VALUES(100000,1,1,10,1,1,8,0,8,'2010/09/27'),
	  ...
	  (1500000,1,NULL,12,8,NULL,NULL,NULL,NULL,'2010/09/30'),
	  (1000000,2,null,13,9,NULL,NULL,NULL,NULL,'2010/09/30'),
	  (1500000,3,null,11,10,NULL,NULL,NULL,NULL,'2010/09/30'),
	  (1500000,4,NULL,11,11,NULL,NULL,NULL,NULL,'2012/01/01'),
	  (1500000,NULL,NULL,11,12,NULL,NULL,NULL,NULL,'2012/01/01')
...
BEGIN
	...
	,CONVERT(NVARCHAR(10),NGAYKETTHUC,103) [ngayketthuc],SISO FROM dbo.LOP
...
AS
BEGIN
    SELECT MABIENLAI,BIENLAI.MADANGKI,TENHOCVIEN,HOCPHI,HOCPHINO,THANHTIEN=(HOCPHI-HOCPHINO)
	,CONVERT(NVARCHAR(20),NGAYTHUTIEN,103) [ngaythutien]
	,NGUOIDUNG.MANHANVIEN,TENNHANVIEN
	FROM dbo.BIENLAI
	JOIN dbo.DANGKI ON DANGKI.madangki = BIENLAI.MADANGKI
	JOIN dbo.NGUOIDUNG ON NGUOIDUNG.MANHANVIEN = BIENLAI.MANHANVIEN
...
EXEC dbo.click_table_HV_moi @maBienLai = 5
GO
