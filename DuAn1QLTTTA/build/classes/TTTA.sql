...
EXEC dbo.click_table_HV_moi @maBienLai = 13
GO
...
BEGIN
	...
	,DANGKI.HOCPHI,HOCPHINO =(dbo.DANGKI.HOCPHI-THANHTIEN),THANHTIEN
	,MANHANVIEN
	,CONVERT(NVARCHAR(20),NGAYTHUTIEN,103) [ngaythutien]
	FROM dbo.BIENLAI
	JOIN dbo.HOCVIEN ON HOCVIEN.MAHOCVIEN = BIENLAI.MAHOCVIEN
...
CREATE PROC themdd(@trangThai BIT,@maBuoiHoc INT,@maHocVien INT)
AS 
BEGIN
    ...
    INSERT INTO dbo.DIEMDANH(TRANGTHAI,MABUOIHOC,MABIENLAI)
	VALUES(@trangThai,@maBuoiHoc,@mabienlai)
END
