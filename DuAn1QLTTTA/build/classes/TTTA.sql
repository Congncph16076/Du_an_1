...
BEGIN
<<<<<<< Updated upstream
    SELECT MABIENLAI,BIENLAI.MAHOCVIEN,TENHOCVIEN,HOCPHI,THANHTIEN,NGUOIDUNG.MANHANVIEN,TENNHANVIEN
	,DIEMTHI,DIEMTHANHPHAN,DIEMTONG=(DIEMTHI+DIEMTHANHPHAN) FROM dbo.BIENLAI
=======
