...
AS
BEGIN
    SELECT MABIENLAI,TENHOCVIEN,HOCPHI,HOCPHINO,THANHTIEN=(HOCPHI-HOCPHINO)
	,CONVERT(NVARCHAR(20),NGAYTHUTIEN,103) [ngaythutien]
...
EXEC dbo.click_table_HV_moi @maBienLai =1
GO
...
-- tìm đăng kí
CREATE PROCEDURE tim_kiem_ban_dang_ki_theo_sdt(@tendangki NVARCHAR(50))
AS
BEGIN
	...
	WHERE TENHOCVIEN = @tendangki
	ORDER BY madangki DESC
END
go
drop proc tim_kiem_ban_dang_ki_theo_sdt
